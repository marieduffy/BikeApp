...
class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        //BOOKKEEPER PAGES
                    ...
                    .antMatchers('/bookkeeperSettings').hasAnyAuthority('BOOKKEEPER', 'OWNER')
            ...
            //EMPLOYEE PAGES
                    ...
                    .antMatchers('/employeeSettings').authenticated()
        ...
        //MANAGER PAGES
                    ...
                    .antMatchers('/settings').hasAnyAuthority('MANAGER', 'OWNER')
        //OTHER PAGES
                    .antMatchers('/changeemail').authenticated()
